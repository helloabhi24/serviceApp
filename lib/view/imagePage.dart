...
class ImagePage extends GetView<HomepageController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
       Container(
        height: Get.height,width: Get.width,decoration: BoxDecoration(image: DecorationImage(
          fit: BoxFit.cover,
          image: FileImage(File(controller.selectedImagePath.value))), color: KColors.white),),
          Align(alignment: Alignment.topRight,
            child: Padding(
              padding:  EdgeInsets.only(top: getVerticalSize(50),right: getHorizontalSize(20) ),
