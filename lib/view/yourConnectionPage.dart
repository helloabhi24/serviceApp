...
class YourConnectionPage extends GetView<GetDriverConnectController> {
  const YourConnectionPage({super.key});
  @override
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      AppText(
                        text: controller.totalCount.toString(),
                ...
                SizedBox(
                  height:
                      controller.getDriverList.isEmpty ? 0 : Get.height * 0.70,
                  // : Get.height,
                  width: Get.width,
